...
//        let findHydrantCollector = SensorCollector(lengthInSeconds: 20, dataLabel: "fire_hydrant", sensors: [.Location, .Speed])
        let findHydrantInstructCollector = CollectorWithSound(fileNames: ["radio_static", "our_monitors_show", "radio_static"], additionalTime: 30, dataLabel: "fire_hydrant", sensors: [.Location, .Speed])
...
//        let passTenTreesCollector = SensorCollector(lengthInSeconds: 20, dataLabel: "tree", sensors: [.Location, .Speed])
        let passTenTreesInstructCollector = CollectorWithSound(fileNames: ["radio_static", "weve_noticed_increased", "radio_static"], additionalTime: 25, dataLabel: "tree", sensors: [.Location, .Speed])
