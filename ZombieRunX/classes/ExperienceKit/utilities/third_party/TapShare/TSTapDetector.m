...
{
    float lastDoubleKnockTimeDifference = fabs(currentDeviceMotion.timestamp - lastDoubleKnock);
    float lastKnockTimeDifference = fabs(currentDeviceMotion.timestamp - lastKnockTime);
